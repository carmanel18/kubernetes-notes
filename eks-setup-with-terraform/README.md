...
```
``` sh
$ git clone https://github.com/carmanel18/eks-terraform-setup
...
$ source ~/.bashrc  
# run the scripts https://github.com/carmanel18/eks-terraform-setup/blob/main/terraform-install.sh
